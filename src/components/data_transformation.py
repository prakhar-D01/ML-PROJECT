...
class DataTransformation:
    def __init__(self):
        self.data_transformation= DataTransformerConfig()
    ...
    def get_data_transformer_object(self):
        try:
            ...
            logging.info("Num columns standard scaling cmplt")
            logging.info("Cat columns encoding cmplt")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info(
                f"Applying preprocessing obj on training & testing dataframe"
            )
